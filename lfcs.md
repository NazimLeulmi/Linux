...
### 5.2 - Managing Advanced Linux Permissions
...
- The advanced Linux permissions are :-
   ...
   - **GUID (set group id) < 2 >**
      ...
      - If its used on a directory , new files will inherit the group owner from the          parent directory .
 ...
 ```bash
 # The first digit in chmod represents advanced permission
 ```
 
 ### 5.3 - Managing Linux permissions with ACLS
